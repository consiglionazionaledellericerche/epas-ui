import { faCalendarDays, faUserXmark, faPlane, faCalendar, faClock } from "@fortawesome/free-solid-svg-icons"
  ...
  const { data: session, status } = useSession()
    ...
    return (
        <NavDropdown title={userLogon} id="personal-data">
            ...
            <NavDropdown.Item href="/personMonths"><FontAwesomeIcon icon={faClock} /> Riepilogo orario</NavDropdown.Item>
            {/*
